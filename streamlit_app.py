...
def show_home_page():
    add_bg_from_local(r'C:\Users\HP\Desktop\seccar.jpg')  # Ensure the path is correct
    ...
    year_options = list(range(2000, 2024))
    ...
    p6 = st.number_input('What is the mileage of the car in Km/l or equivalent ?', 0.0, step=0.1)
...
def show_help_and_support():
    ...
    st.write("Here you can find help and support for using the app.")
